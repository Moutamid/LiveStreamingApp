...
public class Adapter_Fav extends RecyclerView.Adapter<Adapter_Fav.HolderAndroid> {

    private Context context;
    private ArrayList<Model_Channel> androidArrayList;

    public Adapter_Fav(Context context, ArrayList<Model_Channel> androidArrayList) {
